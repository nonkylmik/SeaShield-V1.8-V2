...
import { AppShell } from "../components/seashield/AppShell";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Console view not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This SeaShield view does not exist or has been moved.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The operations console hit an error. Retry, or return to the dashboard.
        </p>
